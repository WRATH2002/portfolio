    ...
    <>
      {props.data === true ? (
        <>
          <div
            id="home_section"
            className="w-full h-[100vh] bg-[#191919] text-white flex justify-center items-center "
            style={{ transition: ".3s" }}
          >
            <div className="mt-[75px] w-[75%] lg:w-[60%] md:w-[75%] flex flex-col justify-center items-center lg:h-[370px] md:h-[370px] h-[calc(100vh-100px)] ">
              <div className="w-full flex flex-col-reverse lg:flex-row md:flex-row">
                ...
                <div className="w-full lg:w-[50%] md:w-[50%] flex justify-center md:justify-end lg:justify-end items-center">
                  <div className="h-[130px] w-[130px] mb-[50px] bg-transparent lg:mb-0 md:mb-0 md:h-[230px] md:w-[230px] lg:h-[230px] lg:w-[230px] flex justify-center items-center   rounded-full  ">
                    <img
        ...
        <>
          <div
            id="home_section"
            className="w-full h-[100vh] bg-slate-100 flex justify-center items-center "
            style={{ transition: ".3s" }}
          >
            <div className="mt-[75px] w-[75%] lg:w-[60%] md:w-[75%] flex flex-col justify-center items-center lg:h-[370px] md:h-[370px] h-[calc(100vh-100px)] ">
              <div className="w-full flex flex-col-reverse lg:flex-row md:flex-row">
                ...
                <div className="w-full lg:w-[50%] md:w-[50%] flex justify-center md:justify-end lg:justify-end items-center">
                  <div className="h-[130px] w-[130px] mb-[50px] lg:mb-0 md:mb-0 md:h-[230px] md:w-[230px] lg:h-[230px] lg:w-[230px] flex justify-center items-center   rounded-full  ">
                    <img
                      className="h-[130px] w-[130px] md:h-[230px] md:w-[230px] lg:h-[230px] lg:w-[230px] object-cover rounded-full drop-shadow-lg"
                      alt="photo"
                      src={photo}
