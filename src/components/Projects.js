  ...
  return (
    <>
      {props.data === true ? (
        <>
          <div
            className="w-full h-[1600px] lg:h-[1500px] md:h-[1500px] flex flex-col justify-center bg-[#191919] text-white  items-center "
            style={{ transition: ".3s" }}
          >
        ...
        <>
          <div
            className="w-full h-[1600px] lg:h-[1500px] md:h-[1500px] flex flex-col justify-center bg-slate-100  items-center "
            style={{ transition: ".3s" }}
          >
            <div className="w-[75%] lg:w-[60%] md:w-[75%] flex justify-start items-center drop-shadow-lg">
              <span className="text-[25px] font-bold">Portfolio</span>
